...
function createApplication (name, dir) {
  ...
  if (program.view) {
    // Copy view templates
    mkdir(dir, 'server/views')
    pkg.dependencies['http-errors'] = '~1.6.3'
    switch (program.view) {
      case 'dust':
        copyTemplateMulti('views', dir + '/server/views', '*.dust')
        break
      case 'ejs':
        copyTemplateMulti('views', dir + '/server/views', '*.ejs')
        break
      case 'hbs':
        copyTemplateMulti('views', dir + '/server/views', '*.hbs')
        break
      case 'hjs':
        copyTemplateMulti('views', dir + '/server/views', '*.hjs')
        break
      case 'jade':
        copyTemplateMulti('views', dir + '/server/views', '*.jade')
        break
      case 'pug':
        copyTemplateMulti('views', dir + '/server/views', '*.pug')
        break
      case 'twig':
        copyTemplateMulti('views', dir + '/server/views', '*.twig')
        break
      case 'vash':
        copyTemplateMulti('views', dir + '/server/views', '*.vash')
        break
    }
  } else {
